...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('todoes', ['Person'])

        # Changing field 'Joker_Visit.worker'
        db.alter_column('todoes_joker_visit', 'worker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['todoes.Person']))


    def backwards(self, orm):
        
        # Deleting model 'Person'
        db.delete_table('todoes_person')

        # Changing field 'Joker_Visit.worker'
        db.alter_column('todoes_joker_visit', 'worker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['todoes.Worker']))
