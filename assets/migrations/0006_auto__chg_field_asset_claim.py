...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asset.claim'
        db.alter_column('assets_asset', 'claim_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Claim'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Asset.claim'
        raise RuntimeError("Cannot reverse this migration. 'Asset.claim' and its values cannot be restored.")
