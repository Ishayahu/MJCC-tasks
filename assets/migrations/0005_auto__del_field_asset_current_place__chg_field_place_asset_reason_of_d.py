...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Asset.current_place'
        db.delete_column('assets_asset', 'current_place_id')


        # Changing field 'Place_Asset.reason_of_drawdown'
        db.alter_column('assets_place_asset', 'reason_of_drawdown', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Place_Asset.drawdown_date'
        db.alter_column('assets_place_asset', 'drawdown_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Asset.current_place'
        raise RuntimeError("Cannot reverse this migration. 'Asset.current_place' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Place_Asset.reason_of_drawdown'
        raise RuntimeError("Cannot reverse this migration. 'Place_Asset.reason_of_drawdown' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Place_Asset.drawdown_date'
        raise RuntimeError("Cannot reverse this migration. 'Place_Asset.drawdown_date' and its values cannot be restored.")
    ...
    models = {
        ...
        'assets.payment': {
            ...
            'cash': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assets.Cash']", 'null': 'True', 'blank': 'True'}),
            'cashless': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assets.Cashless']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'assets.place': {
        ...
        'assets.place_asset': {
            ...
            'drawdown_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'installation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assets.Place']"}),
            'reason_of_drawdown': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'assets.power_suply': {
