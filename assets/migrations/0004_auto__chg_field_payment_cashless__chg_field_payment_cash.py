...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.cashless'
        db.alter_column('assets_payment', 'cashless_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Cashless'], null=True))

        # Changing field 'Payment.cash'
        db.alter_column('assets_payment', 'cash_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Cash'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Payment.cashless'
        raise RuntimeError("Cannot reverse this migration. 'Payment.cashless' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Payment.cash'
        raise RuntimeError("Cannot reverse this migration. 'Payment.cash' and its values cannot be restored.")
