...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Cash.price'
        db.delete_column('assets_cash', 'price')

        # Deleting field 'Cashless.price'
        db.delete_column('assets_cashless', 'price')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Cash.price'
        raise RuntimeError("Cannot reverse this migration. 'Cash.price' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Cashless.price'
        raise RuntimeError("Cannot reverse this migration. 'Cashless.price' and its values cannot be restored.")
