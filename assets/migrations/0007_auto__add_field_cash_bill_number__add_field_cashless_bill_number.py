...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cash.bill_number'
        db.add_column('assets_cash', 'bill_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=40),
                      keep_default=False)

        # Adding field 'Cashless.bill_number'
        db.add_column('assets_cashless', 'bill_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cash.bill_number'
        db.delete_column('assets_cash', 'bill_number')

        # Deleting field 'Cashless.bill_number'
        db.delete_column('assets_cashless', 'bill_number')
