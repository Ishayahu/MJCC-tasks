...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'assets.asset': {
            ...
            'claim': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assets.Claim']", 'null': 'True', 'blank': 'True'}),
        ...
        'assets.cartridge_general_model_printer_model': {
            ...
            'cartrige_model': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'assets.cartridge_model_general_model': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'model_name': ('django.db.models.fields.CharField', [], {'max_length': '140'})
        },
        ...
        'assets.cash': {
            ...
            'bill_number': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'closed_for': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'assets.cashless': {
            ...
            'bill_number': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'contractor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assets.Contractor']"}),
            'date_of_assets': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_of_documents': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_of_invoice': ('django.db.models.fields.DateTimeField', [], {}),
            'dates': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'assets.printer': {
            ...
            'ethernet': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'firm': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lazer': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'model_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'v_color_print': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'v_mono_print': ('django.db.models.fields.IntegerField', [], {}),
