...
DATABASES = {
    'default': {
        ...
        'HOST': '192.168.1.157',                      # Set to empty string for localhost. Not used with sqlite3.
...
MEDIA_ROOT = '/usr/home/ishayahu/tasks/tasks/files/'
...
EMAIL_HOST_PASSWORD = 'JnghfdrfCvcVRJW'
